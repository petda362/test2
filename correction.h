...
bool rotational_correction (double dist_FL, double dist_BL, double dist_FR, double dist_BR, int tolerance, int PWM);  // Performs rotational correction, but needs to be inside a loop to work
